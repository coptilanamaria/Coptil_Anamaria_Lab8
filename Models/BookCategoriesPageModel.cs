...
namespace Coptil_Anamaria_Lab8.Models
    {

    public class BookCategoriesPageModel : PageModel
{
    public List<AssignedCategoryData> AssignedCategoryDataList;
    public void PopulateAssignedCategoryData(Coptil_Anamaria_Lab8Context context,
    Book book)
    {
    ...
    public void UpdateBookCategories(Coptil_Anamaria_Lab8Context context,
